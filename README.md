...
* [4. Security Findings](#4-security-findings)
  * [Finding 1: Insecure Credential Storage in NVRAM ](#finding-1-insecure-credential-storage-in-nvram)
...
| Pin | Physical Position | Measured Voltage | Identified Function |
| :--- | :--- | :--- | :--- |
| **Pin 1** | Far Right | 3.362 V (Steady DC) | VCC (Power Rail) |
| **Pin 2** | Middle Right | 2.612 V (Active Pulses) | Router TX (Transmit) |
| **Pin 3** | Middle Left | 6.1 mV (Logic Low / Floating) | Router RX (Receive) |
